    ...
    switch (this.state) {
        ...
        case states.LOCAL_FILE_HEADER_SUFFIX:
            ...
            if (this.options.debug) {
                ...
                console.log("decoded local file entry:", debugObj);
            }
...
UnzipStream.prototype._readExtraFields = function (data) {
    ...
    while (index < data.length) {
        ...
        if (this.options.debug) {
            console.log("entry contains extra data with id: 0x" + vars.extraId.toString(16), "length:", vars.extraSize);
        }
...
UnzipStream.prototype._decodeString = function (buffer, isUtf8) {
    // TODO: allow passing custom codepage
    if (isUtf8) {
